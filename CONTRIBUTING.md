...
It's better to discuss an **API** before actually start implementing it. You can open an [**Issue on Github**](https://github.com/wellwelwel/yaml.min/issues/new), so we can discuss the **API** design implementation ideas.
